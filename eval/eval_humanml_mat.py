...
from utils.model_util import create_model_and_diffusion, load_model_wo_clip, create_model_and_diffusion_general_skeleton
...
def evaluation(eval_wrapper, gt_loader, eval_motion_loaders, log_file, replication_times, diversity_times, mm_num_times, run_mm=False):
    with open(log_file, 'w') as f:
        all_metrics = OrderedDict({'FID': OrderedDict({}),
...
if __name__ == '__main__':
    ...
    log_file = os.path.join(os.path.dirname(args.model_path), 'eval_humanml_mat_{}_{}'.format(name, niter))
    ...
    model, diffusion = create_model_and_diffusion_general_skeleton(args, gen_loader)
