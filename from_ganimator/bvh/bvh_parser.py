import torch
import from_ganimator.bvh.bvh_io as bvh_io
import numpy as np
from from_ganimator.bvh.Quaternions import Quaternions
from from_ganimator.bvh.skeleton_database import SkeletonDatabase
from from_ganimator.models.kinematics import ForwardKinematicsJoint
from from_ganimator.models.transforms import quat2repr6d, quat2mat
from from_ganimator.models.contact import foot_contact
from from_ganimator.bvh.bvh_writer import WriterWrapper


class Skeleton:
    def __init__(self, names, parent, offsets, joint_reduction=True, contact_names=[]):
        self._names = names
        ...
        if joint_reduction:
            ...
            self.contact_threshold = 0.02 # todo: make an argument
...
class BVH_file:
    def __init__(self, file_path, no_scale=False, requires_contact=False, joint_reduction=True, contact_names=[]):
