...
### Tests:
### NOTE: DO NOT USE --eval_mode bvh! It has a bug!
### Supported modes are --eval_mode [npy_rot|npy_loc]

GT vs. GT:
```
python -m ata_eval.eval_truebones --eval_mode npy_rot --eval_gt_dir /home/dcor/inbargat1/multi-skeleton-mdm/dataset/truebones/zoo/processed_bvh_rots/motions --eval_gen_dir /home/dcor/inbargat1/multi-skeleton-mdm/dataset/truebones/zoo/processed_bvh_rots/motions
```

GT vs. Gen (not final):
```
python -m ata_eval.eval_truebones --eval_mode npy_rot --eval_gt_dir /home/dcor/inbargat1/multi-skeleton-mdm/dataset/truebones/zoo/processed_bvh_rots/motions --eval_gen_dir /home/dcor/inbargat1/multi-skeleton-mdm/save/dinosaurs_model_l_simple_trans.dec_dataset_truebones_bs_8_latentdim_128/samples_dinosaurs_model_l_simple_trans.dec_dataset_truebones_bs_8_latentdim_128_000250000_seed10
```


<!-- GT vs. GT:
```
python -m ata_eval.eval_truebones --eval_gt_dir /home/dcor/guytevet/multi-skeleton-mdm/dataset/truebones_toy --eval_gen_dir /home/dcor/guytevet/multi-skeleton-mdm/dataset/truebones_toy
```

GT vs. Gen (not final):
```
python -m ata_eval.eval_truebones --eval_gt_dir /home/dcor/inbargat1/multi-skeleton-mdm/dataset/truebones/zoo/processed_bvh_rots/bvhs --eval_gen_dir /home/dcor/inbargat1/multi-skeleton-mdm/save/eval/bvh
``` -->
